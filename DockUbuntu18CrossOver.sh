...
sudo docker run -p 5900:5900 -p 8080:6080 -e USER=aank -e PASSWORD=LinggaHosting --name ubuntu18.04 --privileged --shm-size 1g -d /dev/shm:/dev/shm aank999/ubuntu-vnc
